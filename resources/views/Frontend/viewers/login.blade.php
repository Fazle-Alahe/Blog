    ...
    <section class="page-header">
        <div class="container-xl">
            <div class="text-center">
                <h1 class="mt-0 mb-2">Login here..</h1>
				...
				<div class="col-lg-8 m-auto">
					...
					<form action="{{route('loggged.viewer')}}" id="contact-form" class="contact-form" method="POST">
						...
						<div class="messages"></div>
							...
							<div class="column col-md-8 m-auto">
								<!-- Email input -->
							...
							<div class="column col-md-8 m-auto">
								...
								<div class="form-group">
                                    ...
                                    <div class="column col-md-8 text-right pe-5">
                                        <!-- Message textarea -->
                                        <strong>Not register yet?<a href="{{route('registration')}}">Register</a></strong>
                                    </div>
